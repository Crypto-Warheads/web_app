...
export interface ERC6551AccountInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "executeCall"
      | "isValidSignature"
...
export interface ERC6551Account extends BaseContract {
  connect(runner?: ContractRunner | null): ERC6551Account;
  waitForDeployment(): Promise<this>;

  interface: ERC6551AccountInterface;
